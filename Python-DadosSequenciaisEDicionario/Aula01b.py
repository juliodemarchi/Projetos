...
print(f'Dicionário após adicionar profissao: {dicionario}')

# Modificando o valor associadoa uma chave existente
dicionario["idade"] = 26
print(f'Dicionario após modificar a idade: {dicionario}')
...
# Ussando o método get() para acessar valores de forma segura
profissao = dicionario.get("profissao", "Desconhecido")
print(f'Profissão: {profissao}')

# Limpando todo os elemntos do dicionário
dicionario.clear()
print(f'Dicionário após limpar todos os elemntos: {dicionario}')